  ...
  return (
    <form onSubmit={handleSubmit} className="w-full max-w-2xl">
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 sm:p-7">
        ...
        <button
          type="submit"
          className="mt-8 w-full flex items-center justify-center gap-2 px-6 py-3.5 bg-[#1e3a5f] text-white text-sm font-semibold rounded-lg hover:bg-[#162d4a] active:bg-[#0f2137] transition-colors"
        >
