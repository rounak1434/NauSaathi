  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 animate-fade-in animate-fade-in-delay-2">
      ...
      <div className="bg-[#f0f4ff] border border-[#d4dff7] rounded-lg p-5 mb-6 flex items-center gap-4">
        ...
        <div>
          <p className="text-xl font-bold text-[#1e3a5f]">{data.displayLabel}</p>
      ...
      <div className="mb-2">
        ...
        <div className="relative">
          ...
          <div className="h-2 bg-gray-100 rounded-full relative overflow-visible">
            ...
            <div
              className="absolute top-0 h-full bg-[#1e3a5f]/15 rounded-full"
              style={{
                left: `${idealStartPct}%`,
          ...
          <div className="flex justify-between mt-3">
            ...
            <div className="flex flex-col items-start" style={{ marginLeft: `${todayPct}%` }}>
              <div className="w-2.5 h-2.5 rounded-full bg-[#1e3a5f] border-2 border-white shadow-sm -mt-[22px]" />
            ...
            >
              <span className="text-[11px] font-semibold text-[#1e3a5f] mt-1">
        ...
        <div className="flex items-center gap-3 mt-6 text-xs text-gray-500">
          ...
          <ArrowRight className="w-3.5 h-3.5 text-gray-300" />
          <span className="bg-[#eef2ff] border border-[#d4dff7] rounded-md px-3 py-1.5 font-semibold text-[#1e3a5f]">
            Ideal Window
          </span>
        </div>
      </div>
